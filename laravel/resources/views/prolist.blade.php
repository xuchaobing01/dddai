                    ...
                    <div class="clearfix tab_content">
                        ...
                        <div class="clearfix nr">
                            ...
                            <table class="table">
                                ...
                                @forelse($pros as $pro)
                                <tr>
                                   <td class="f">{{$pro->pid}}</td>
                                   <td>{{date("Y-m-d H:i:s",$pro->pubtime)}}</td>
                                   <td class="tr"><span>{{$pro->name}}</span></td>
                                   <td class="tr">{{$pro->money}}</td>
                                   <td>{{$pro->age}}</td>
                                   <td class="tr">{{$pro->mobile}}</td>
                                   <td class="">
                                       @if($pro->status==-1)
                                            审核失败
                                       @elseif($pro->status==0)
                                   ...
                                   <td class="l"><a href="{{url('check',[$pro->pid])}}">审核</a></td>
                                </tr>
                                @empty
                                    <tr>
                                        <td colspan="8" class="wujilu" id="errorMsg">暂无记录</td>
                                    </tr>
