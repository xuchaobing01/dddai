                        ...
                        <form id="loginForm" method="post" class="nwd-formUi" action="{{url('auth/login')}}">
                            ...
                            <tr>
                                <td class="txcenter fc_9">
                                    没有帐号？<a title="立即免费注册" class="blue ml_15" href="{{url('auth/register')}}">免费注册</a>
                                </td>
...
<div class="login_foot w1000 txcenter">
    ...
    <div class="line3 mt_10">
        <a href="#" target="_blank" class="img1" rel="nofollow"><img width="70" height="32" src="/image/px.gif"></a>
            <a href="#" target="_blank" class="img2" rel="nofollow"><img width="70" height="32" src="/image/px.gif"></a>
