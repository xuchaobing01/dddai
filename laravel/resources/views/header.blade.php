    ...
    <div class="header w1190 clearfix">
        ...
        <div class="fr login clearfix">
            ...
            <div class="login_bt">
                ...
                <a href="{{url('home')}}" rel="nofollow" class="hello">{{\Auth::user()->name}}</a>
                <a href="{{url('auth/logout')}}" id="loginOut" class="hello">退出</a>
                @endif
            </div>
            @if(\Auth::check())
            <dl>
                <dt><a class="txnone" rel="nofollow" title="账户中心" href="{{url('home')}}">账户中心</a></dt>
                <dd><a class="txnone" title="我的投资" rel="nofollow" href="{{url('mytz')}}">我的投资</a></dd>
                <dd><a title="我的借款" rel="nofollow" target="_blank" href="{{url('myzd')}}">我的借款</a></dd>
            </dl>
            @endif
    ...
    <div class="w1190 logo clearfix">
        ...
        <div class="fr righ">
            <ul class="nav clearfix">
                ...
                <li class="rela">
                    <a class="one" title="新手导航" target="_blank" href="http://www.baidu.com">新手导航 </a>
                </li>
                <li style="margin-right:0;">
                    <a class="one" title="社区" target="_blank" href="http://www.baidu.com">社区 </a>
                </li>
            </ul>
        </div>
    </div>
