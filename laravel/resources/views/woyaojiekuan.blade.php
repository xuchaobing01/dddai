...
<head>
    ...
    <meta name="description"
          content="点点贷贷款专栏专注于为个人和企业提供2013年最新的贷款利息查询、小额贷款、个人贷款、商业贷款、短期借款期限、汽车抵押贷款、房屋抵押贷款、信用贷款、申请贷款条件等贷款咨询服务。">
...
<form id="applyForm" name="applyForm" action="{{url('jie')}}" method="POST">
    ...
    <div class="application">
        ...
        <div class="delCon">
            ...
            <div class="iptBox">
                <span>借款金额</span>
                <input id="loanAmount" name="money" maxlength="8" placeholder="请输入借款金额" type="text"
                       value="{{old('money')}}">
                @if($errors->has('money'))
            ...
            <div class="iptBox">
                ...
                <img src="" name="imgc" id="imgc" alt="换一张" class="get-code" height="36" width="80">
                {{--<img src="{{url('captcha')}}" name="imgc"  class="get-code" height="36" width="80">--}}
            ...
            <div class="iptBox">
                ...
                <i>
                    <button class="get-code" id="dtmbtn" name="dtmbtn">获取验证码</button>
                </i>
            </div>
    ...
    <div class="clearfix out">
        ...
        <div class="r">
            <ul>
                ...
                <li class="line3 fc_3">关注我们<a href="#" target="_blank" class="ico" rel="nofollow"><i
                                class="i_s"></i></a><i class="i_q" onclick="showCon_2()"></i></li>
            </ul>
        </div>
    </div>
    ...
    $(function () {
        ...
        $("#imgc").on('click',function(){
            $.ajax({
                ...
                dataType: 'json',
                success: function (res) {
                    $("#imgc").attr('src', res.url);
                }
            });
        });
        $("#imgc").click();

        $("#dtmbtn").on('click', function () {
            ...
            var sendsm = this;
            var time = 10;
            var clacker = setInterval(function () {
                if (time <= 1) {
                    $("#dtmbtn")[0].disabled = false;
                    $("#dtmbtn").html('获取验证码');
                    clearInterval(clacker);
                } else {
                    time -= 1;
                    $("#dtmbtn").html(time);
                }
